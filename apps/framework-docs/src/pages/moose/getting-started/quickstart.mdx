...
import { RectangleEllipsis, Square, Workflow, Database, FileCode, Play, CheckCircle, Clock, MapPin, Laptop, Lightbulb, FolderTree } from "lucide-react";
...
_You now have the Moose CLI to manage your analytics backend._
...
<Callout type="success">
Your local analytics stack is running. You can now send data to Moose and query it.
</Callout>
</ToggleBlock>
...
to see how data flows from ingestion to analytics APIs. Open `app/ingest/models.ts` or `models.py` to see how data models are defined.
</Callout>
...
<Callout type="info" title="Open a new terminal window">
...
<Callout type="success">
You now have a complete data pipeline working end-to-end
</Callout>
