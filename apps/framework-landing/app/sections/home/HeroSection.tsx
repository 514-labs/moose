  ...
  return (
    <Section className="max-w-5xl mx-auto sm:my-64 mt-0 pt-0">
      <Grid className="flex lg:flex-row flex-col items-stretch content-center justify-center">
        ...
        <HalfWidthContentContainer className="border p-5 space-y-5 rounded-2xl lg:w-1/2 w-full">
          {/* Titles */}
        ...
        <HalfWidthContentContainer className="border p-5 space-y-5 rounded-2xl overflow-hidden lg:w-1/2 w-full">
          {/* With framework card */}
          {/* Titles */}
  ...
  return (
    <Fragment>
      <Section className="2xl:max-w-6xl mx-auto flex flex-col items-center px-5 mt-16 sm:my-64">
        <Grid>
          <FullWidthContentContainer>
            <Display className="text-center mb-0 w-full">
              {content.tagLine}
            </Display>
            <Heading
