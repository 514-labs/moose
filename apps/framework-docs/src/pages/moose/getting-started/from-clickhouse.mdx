...
|------------|-------------------|-------|
| **Local setup** | `http://default:@localhost:8123/?database=mydb` |
| **ClickHouse Cloud** | `https://username:password@your-cluster.clickhouse.cloud:8443/?database=production` |
| **ClickHouse Playground** | `https://explorer:@play.clickhouse.com:443/?database=default` |
