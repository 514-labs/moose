...
- Starts only containers needed for enabled features
- Validates container health before proceeding
- Generates dynamic Docker Compose configurations
- Handles container networking and port management

### Supported Containers

**ClickHouse** (when `olap` feature is enabled)
- Columnar OLAP database for analytical queries
