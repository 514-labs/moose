...
1. **[Define your schemas](./data-modeling#schema-definition)** - Create type definitions in TypeScript or Python
2. **Choose your components** - Decide which infrastructure pieces to create (APIs, streams, tables)
3. **Fine-tune behavior** - More granular control over how your infrastructure should behave if desired
...
- **Type-driven development** - Catch errors at dev time, not runtime
- **Full control** - Choose exactly what to create and how it should behave
- **Zero schema drift** - Change types in one place, entire stack updates
