  ...
  return (
    <div className="py-4">
      <div className="text-muted-foreground max-w-xl">
        This table is an ingestion Clickhouse table. You cannnot query it directly. To get a preview of the data, head to its associated view 
      </div>
      <Link className=" underline" href={`/infrastructure/databases/${view.database}/tables/${view.uuid}?tab=query`}>
...
export default function TableTabs({table, cliData, jsSnippet, pythonSnippet, clickhouseJSSnippet, clickhousePythonSnippet}: TableTabsProps) {
    ...
    return (
        <Tabs  value={tab ? tab : "overview"} className="h-full" onValueChange={(value) => {
                  ...
                  <div className="col-span-12 xl:col-span-6">
                    <Card className="rounded-3xl">
                      ...
                      <CardContent >
                        ...
                        {model && model.columns.map((field, index) => (
                          <div key={index}>
                            <div className="flex py-4">
                        ...
                        <div className="pb-4">
                          ...
                          <SnippetCard title="Ingestion point">
                            <code className="bg-muted">
                              {cliData.project && `http://${cliData.project.local_webserver_config.host}:${cliData.project.local_webserver_config.port}/${infra.ingestionPoints[0].route_path}`}
                            </code>
                          </SnippetCard>
                        </div>
                        <div className="py-4">
                          ...
                          <div>
                            ...
                            <h2 className="py-2 flex flex-row items-center">
                              ...
                              <Button variant="outline" onClick={() => {
                                  router.push(`${pathName}?${createTabQueryString("query")}`)
              ...
              <TabsContent className="h-full" value="query">
                {/* add query here */}
                  <div className="p-0 h-full">
                    {tableIsView(table) ? <QueryInterface table={table} related={cliData.tables}/> : 
