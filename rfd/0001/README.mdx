...
There is a prototype script in this repository, `scripts/new.js`, that will automate the process.

```shell
$ node scripts/new.js “My title here”
```
...
```shell
$ git commit -am ‘frd(0042): Add RFD for <Title>’
$ git push origin "rfd/0042"
```
