...
| functions  | The folder where you define your [Streaming Functions](../building/streaming-functions/intro) |
| blocks     | The folder where you define your [Blocks](../building/aggregations/intro)                     |
