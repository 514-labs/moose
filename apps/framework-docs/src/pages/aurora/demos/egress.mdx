---
title: "Egress Demo"
description: "Learn how to create data egress APIs using Aurora with a step-by-step TypeScript example"
---
...
> Can you create a API that returns every aircraft within X miles of Y,Z coordinates.
