...
<CTACard
  title="Learn More"
  description="Learn more about the supported column types in Moose"
  ctaLink="/stack/olap/schema-optimization"
  ctaLabel="Learn More →"
...
- **Add new columns** at the end of the schema when possible
- **Use `EXTERNALLY_MANAGED`** lifecycle for production tables
...
<CTACard
  ...
  description="Learn more about the migration strategy for your ClickHouse tables"
  ctaLink="/stack/olap/schema-migrations"
  ctaLabel="Learn More →"
  orientation="horizontal"
/>
</CTACards>