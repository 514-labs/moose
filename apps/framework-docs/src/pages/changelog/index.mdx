...
![Starting a new chat](apps/framework-docs/src/pages/changelog/new-chat.png)
...
![Autocomplete](apps/framework-docs/src/pages/changelog/autocomplete.png)

Here's an example of chat with tool-calls.

![Chat](apps/framework-docs/src/pages/changelog/chat.png)
...
![Artifacts](apps/framework-docs/src/pages/changelog/artifact.png)
