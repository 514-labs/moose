...
## Get Started
```bash filename="Install MooseStack" copy
...
<CTACards rows={3} columns={1}>
  <CTACard
    ...
    description="Start with a simple demo app to get a feel for MooseStack"
  ...
  <CTACard
    ...
    description="Start with a template for integrating MooseStack with complex microservices architectures"
