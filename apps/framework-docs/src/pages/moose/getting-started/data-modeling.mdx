...
- [ClickHouse Tables and Materialized Views](#modeling-olap-tables-views-and-materialized-views) (automatically generated DDL)
- [Redpanda/Kafka Streams](#modeling-kafkaredpanda-streams) (schema registry and topic validation)
- [API Contracts](#modeling-apis-request-and-response-validation) (request/response validation and OpenAPI specs)
- [Workflow Task Input and Output Types](#modeling-workflow-tasks-inputs-and-outputs) (typed function inputs/outputs)
...
### Use Case 1: Simple Data Model Shared Across Infrastructure
...
### Use Case 2: Composite Types Shared Across Infrastructure
...
### Use Case 3: ClickHouse-Specific Types (Standalone vs IngestPipeline)
...
### Use Case 4: ConsumptionAPI with Runtime Validators

ConsumptionAPIs use runtime validation to ensure query parameters meet your requirements:
