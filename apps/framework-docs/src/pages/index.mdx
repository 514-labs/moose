...
<div className="flex md:flex-row flex-col justify-start items-center">
  <CTACard
    ...
    ctaLink="/getting-started/new-project"
    Icon={Zap}
  />
  <CTACard
    title="Tutorial"
    description="Learn by building an end-to-end Moose application through a guided tutorial"
    ctaLabel="Learn Moose"
    ctaLink="/learn-moose"
    Icon={GraduationCap}
  />
</div>
...
We include some example applications in the [examples section](/templates), so you can see how Moose can be used to build a variety of applications:
