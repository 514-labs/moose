...
At the infrastructure level, Moose currently supports a best-in-class open source analytical stack, including Clickhouse (realtime 
OLAP database), RedPanda (streaming), and Temporal (orchstration).
