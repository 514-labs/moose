...
<br/><br/>
Migration functions are unique because they initially executed on all the data in the table for the previous version. This is the **Initial Data Load** part of the migration.
<br/><br/>
