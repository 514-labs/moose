...
See [connect docs](../aurora/reference/cli-reference#aurora-connect-clickhouse). One line configureation to connect your Client of choice to your ClickHouse databse with Aurora's MCP tools. Choose your MCP client of choice with the `--mcp` flag.
