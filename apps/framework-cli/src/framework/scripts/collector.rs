use crate::{framework::languages::SupportedLanguages, utilities::constants::SCRIPTS_DIR};
...
mod tests {
    ...
    fn test_invalid_script_name() {
        assert!(Script::from_file(PathBuf::from("invalid.py")).is_err());
    }
