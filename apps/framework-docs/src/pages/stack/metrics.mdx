...
description: Metrics Console for Moose
---
...
The following metrics are calculated across all API endpoints in your Moose application:
...
For each API endpoint that is configured in your Moose application, we also provide the following metrics:
...
| `BYTES/SEC`   | Average number of bytes of data returned by the streaming function per second |../../components
