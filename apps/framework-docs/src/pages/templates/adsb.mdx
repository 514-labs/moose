...
Drag the frontend folder to the chat as context, as well as the file containing the generated egress API, and prompt "using the packagages you've been given, generate a frontend showing the data offered by the API."
</Callout>