...
to users and contributors all the time to make sure we're creating something valuable. If you're at all
interested in what we're building here, then we'd love to talk to you!
[Book a chat with us](https://calendly.com/d/cmh5-nrj-9nc/talk-to-engineering) so we can learn more about you and your use cases. We can't wait to hear from you!
...
<Columns>
  ...
  />
  <Column
    heading="Enterprise Data Platforms"
...
We include some example applications in the [templates section](/templates/product-analytics/), so you can see how Moose can be used to build a variety of applications:

<ChipButton href="/templates/product-analytics" label="Product Analytics" />
...
- [Streaming Functions](/stream-processing)
- [Blocks](/db-processing)
...
Learn more in the [architecture documentation](/architecture).
