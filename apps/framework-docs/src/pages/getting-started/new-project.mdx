...
Now that you're up and running in Dev mode, you can visit [http://localhost:3001](http://localhost:3001) to view your new MooseJS application console. From here you can inspect your application, browse the objects you've created, query and review data that you've sent into your Moose app, and more.
