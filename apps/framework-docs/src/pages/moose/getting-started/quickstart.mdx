...
<div className="flex items-center gap-2 text-sm text-muted-foreground mb-6 bg-muted/50 p-2 rounded-md">
  <MapPin size={16} />
  <span>You are here: <strong>Quickstart</strong> — Build your first analytical backend in 5 minutes with ClickHouse, Redpanda, and APIs</span>
</div>
...
<InlineProps
  items={[
    ...
    {
      Icon: Sparkles,
      text: "Local ClickHouse, Redpanda, and APIs"
    }
  ]}
/>
