...
![Starting a new chat](apps/framework-docs/public/new-chat.png)
...
![Autocomplete](apps/framework-docs/public/autocomplete.png)

Here's an example of chat with tool-calls.

![Chat](apps/framework-docs/public/chat.png)
...
![Artifacts](apps/framework-docs/public/artifact.png)
