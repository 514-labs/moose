...
|-------------------|-----------------------------------------------------------------------|------------------------------------|-------------|
| **Ingestion**     | [Ingest APIs, Ingestion Pipeline](/moose/building/ingestion)                                           | HTTP **POST** endpoints            | Rust        |
| **Streaming**     | [Streams](/moose/building/streams)| Streaming topics & consumers       | Redpanda    |
| **Database**      | [Tables](/moose/building/olap-table), [Views](/moose/building/materialized-views)                        | OLAP tables & views                | ClickHouse  |
| **Orchestration** | [Workflows](/moose/building/workflows)                                               | Task queue & workers               | Temporal    |
| **Consumption**   | [Analytics APIs](/moose/building/consumption-apis)                                   | HTTP **GET** endpoints             | Rust        |
