...
Next, install Node.js or Python depending on your MooseStack Applications:
...
Additionally, create a `.env.prod` file for your MooseStack Applications-specific secrets and configuration:
...
If your MooseStack Applications uses Temporal for workflow orchestration, the configuration above includes all necessary services based on the
...
2. When code is pushed to your repository:
   - The GitHub Actions runner builds your MooseStack Applications
