...
<Python>
```python filename="app/datamodels/Foo.py"
...
<TypeScript>
```typescript filename="app/datamodels/Foo.ts"
...
```python filename="app/scripts/example_ingest_script/1.ingest.py"
...
@task
def generate(data: dict):  # The name of your script
    """
...
```typescript filename="app/scripts/ExampleIngestWorkflow/1.ingest.ts"
