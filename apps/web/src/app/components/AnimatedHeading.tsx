...
const getDefaultStyle = (size: Size) => {
    ...
    if (size === "display-md") {
        return "text-typography-primary text-3xl 2xl:text-6xl 3xl:text-7xl"
    }
...
export const AnimatedHeading = ({content, size, onScroll, triggerRef, className,  position}: HeadingProps) => {
