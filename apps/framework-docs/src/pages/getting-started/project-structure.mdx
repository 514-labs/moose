...
<FileTree>
  ...
  <FileTree.Folder name="app" defaultOpen>
    ...
    <FileTree.Folder name="aggregations" defaultOpen>
...
| functions    | The folder where you define your [Streaming Functions](../building/streaming-functions/intro) - note that the hierarchy of folders here dictates the routing and orchestration of your streaming functions. |
| aggregations | The folder where you define your [Aggregations](../building/aggregations/intro)                                                                                                                             |
| apis         | The folder where you define your [Consumption APIs](../building/consumption-apis/intro)                                                                                                                     |
