...
exports.getMooseUrl = exports.createOctokit = exports.saveEtag = exports.loadEtag = exports.ensureDataDir = exports.ETAG_FILE_PATH = exports.octokit = void 0;
...
var saveEtag = function (etag) {
    try {
        ...
        fs.writeFileSync(exports.ETAG_FILE_PATH, JSON.stringify({
            etag: etag,
...
var getMooseUrl = function () {
    return process.env.MOOSE_URL || "http://localhost:4000";
};
exports.getMooseUrl = getMooseUrl;
