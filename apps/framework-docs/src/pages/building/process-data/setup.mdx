...
<Callout>
  Hints: - Make sure You import the source and destination Data Models from the
  correct paths in your app - Replace `functionName` with whatever descriptive
  name you choose for your function - Replace `SourceDataModel` and
  `DestinationDataModel` with the actual names of your Data Models - The default
  export is important because Moose uses it to identify the entry point into the
  Streaming Function
  <br />
</Callout>
