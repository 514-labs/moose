...
import {
  ...
  Python,
  LanguageSwitch,
} from "../components/language-wrappers";
...
<TypeScript>
  ```bash filename="Terminal" copy git --version && node --version && docker
  --version ```
</TypeScript>

<Python>
  ```bash filename="Terminal" copy git --version && python3 --version && docker
  --version ```
</Python>
...
<TypeScript>
  ### Run `create-moose-app` in your terminal ```bash filename="Terminal" copy
...
<TypeScript>```bash filename="Terminal" copy npx moose-cli ls ```</TypeScript>

<Python>```bash filename="Terminal" copy moose-cli ls ```</Python>
...
<TypeScript>### Open `models.ts` and Inspect the Data Models</TypeScript>

<Python>### Open `models.py` and Inspect the Data Models</Python>
