...
<CTACard
  ...
  ctaLink={`${PathConfig.olap.path}/model-table`}
  ctaLabel="Learn More →"
...
<CTACard
  ...
  ctaLink={`${PathConfig.olap.path}/model-materialized-view`}
  ctaLabel="Learn More →"
...
<CTACard
  ...
  ctaLink={`${PathConfig.olap.path}/schema-optimization`}
  ctaLabel="Learn More →"
...
<CTACard
  ...
  ctaLink={`${PathConfig.olap.path}/apply-migrations`}
  ctaLabel="Learn More →"
...
<CTACard
  ...
  ctaLink={`${PathConfig.olap.path}/read-data`}
  ctaLabel="Learn More →"
...
<CTACard
  ...
  ctaLink={`${PathConfig.olap.path}/insert-data`}
  ctaLabel="Learn More →"
  orientation="horizontal"
/>
</CTACards>
