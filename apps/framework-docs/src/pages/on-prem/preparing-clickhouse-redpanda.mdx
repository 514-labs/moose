...
Your hosted Moose application requires access to hosted Clickhouse and Redpanda service instances. You can standup open source versions of both applications in your own environments or opt to use cloud hosted versions available at:
