...
Generates a new Aggregation for you, including creating and structuring the necessary directory and file. Learn more in the [Aggregations docs](../building/aggregations/setup).
