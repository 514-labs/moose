...
import { CTACard, ZoomImg } from "../components";
...
<Grid className="mt-4 md:gap-x-0 border">
  ...
  Build a backend system to power enterprise data products like BI software, data exploration tools, and more to create feature-rich, interactive data applications for your users and stakeholders. Examples include:
...
<Cards>
  <Card title="Product Analytics" href="/templates/product-analytics" />
</Cards>
