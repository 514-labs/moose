...
description: A real-time heart rate monitoring dashboard with leaderboard functionality
---
...
- Real-time heart rate monitoring with interactive graphs
