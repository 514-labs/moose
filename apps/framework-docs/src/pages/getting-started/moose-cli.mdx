...
Starts a development environment running the full stack of your MooseJS application locally (just as it would run in production). As you develop your MooseJS application locally, changes you make to your code base will be automatically reflected here in real time (when you save changes).
