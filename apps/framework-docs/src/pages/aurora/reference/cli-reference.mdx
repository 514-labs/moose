  ...
  args={[
    {
      ...
      examples: ["clickhouse://user:pass@host:port/db"]
    },
    {
      name: "--mcp <host>",
      description: "Choice of which MCP host to use. Default: cursor-project.",
      examples: ["claude-desktop", "cursor-global", "cursor-project", "windsurf-global"]
    }
  ]}
/>
