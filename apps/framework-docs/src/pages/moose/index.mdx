...
<div className="flex flex-col md:flex-row gap-4 my-8">
  <Link href="/moose/getting-started/quickstart">
...
<FeatureGrid>
  <FeatureCard
    href="/moose/building/data-modeling"
    Icon={Icons.models}
  ...
  <FeatureCard
    href="/moose/building/materialized-views"
    Icon={Icons.db}
  ...
  <FeatureCard
    href="/moose/building/consumption-apis"
    Icon={Icons.api}
