...
3. Update your Moose environment variables to use the new moose user:
...
4. For additional security in production, consider using Docker secrets for passwords.
