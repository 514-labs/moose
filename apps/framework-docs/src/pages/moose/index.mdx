...
Moose is an open source framework for building analytical backends to power user-facing or operational analytics using 
native TypeScript/Python.

You use Moose's TS/Py primitives to define the logical components of your analytical backend: including data models, 
transformations, and API endpoints. These primitives become reusable and type-safe across your entire full stack application.

Under the hood, Moose implements your components by abstracting, configuring, and orchestrating your OLAP and streaming infrastructure. 
This allows you to focus on the unique and interesting parts of your analytical app, instead of spending time on integration 
and boilerplate. 

At the infrastructure level, Moose currently supports a best-in-class open source analytical stack, including 
[ClickHouse](https://github.com/ClickHouse/ClickHouse) (realtime OLAP database), 
[Redpanda](https://github.com/redpanda-data/redpanda) (streaming), and 
[Temporal](https://github.com/temporalio/temporal) (orchestration).
