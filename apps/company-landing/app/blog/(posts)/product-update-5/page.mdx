...
In dev mode, you can see the metrics that your moose app is collecting by simply visiting `localhost:4000/metrics`. This endpoint is also while running moose locally. These metrics are collected using Prometheus instrumentation and metrics format.
...
All of the metrics outputted to this endpoint are in Prometheus format.
