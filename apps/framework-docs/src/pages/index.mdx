...
<Columns columns={2}>
  <Column
    heading="Build Production-Ready Applications in Days, Not Months"
    body="Iterate confidently with a unified local development environment that reflects your production setup."
    list={[
  ...
  />
  <Column
    heading="Catch Issues at Dev and Build Time"
    body="Prevent errors before they happen in production with type safety throughout your entire data pipeline."
    list={[
      "Typed data models with automated validation",
...
<Columns columns={2}>
  <Column
    heading="Language-Native Experience"
    body="Model and transform data in the languages you already know, not just SQL."
    list={[
      "Native Python and TypeScript data models",
      "Realtime processing with familiar languages",
      "ORM experience built for analytical workloads"
    ]}
    className="col-span-6 border-r"
  />
  <Column
    heading="Open Source and Configurable"
    body="Easily extend Moose to fit your specific needs and infrastructure."
    list={[
      "Use with popular data warehouses",
      "Support for existing data connectors",
...
<div className="my-6 text-lg text-center max-w-2xl mx-auto">
  Ready to build your first data-intensive application with Moose? Follow our quick start guide to set up your development environment and create your first project in minutes.
</div>

<CTACards>
  <CTACard
    title="Create Your First Moose Project"
    description="Get up and running with your own Moose project in minutes"
    ctaLink="/quickstart"
    ctaLabel="Quick Start"
    cardName="Quick Start"
