...
<Callout type="info" title="Read the OLAP Migrations Guide" href={`${PathConfig.olap.path}/apply-migrations`} ctaLabel="View Docs">
For more information on how to apply migrations to your OLAP tables, see the specific migration guide in the OLAP module docs.
</Callout>
