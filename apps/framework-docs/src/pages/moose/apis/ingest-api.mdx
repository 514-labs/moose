...
## Overview
Moose Ingestion APIs are the entry point for getting data into your MooseStack Applications. They provide a fast, reliable, and type-safe way to move data from your sources into streams and tables for analytics and processing.
