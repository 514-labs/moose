...
- [Learn more about ingestion pipelines](/moose/building/ingestion)
...
<Callout type="info" title="When to use">
  Use `Workflows` for periodic ETL/ELT jobs to sync data from external systems into your analytical backend.
</Callout>

- [Learn more about workflows](/moose/building/workflows)
...
<Callout type="info" title="When to use">
  Use a `MaterializedView` to power fast-loading dashboards and real-time analytics where query latency is critical.
</Callout>
...
- [Learn more about streams](/moose/building/stream-processing)
...
- [Learn more about Dead Letter Queues](/moose/building/dead-letter-queues)
