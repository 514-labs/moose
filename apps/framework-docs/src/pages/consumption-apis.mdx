...
- **Automatic API Documentation:** Take advantage of the auto generated OpenAPI specification, hosted on your local dev server at [http://localhopst:5001/openapi.yaml](http://localhopst:5001/openapi.yaml), for interactive API documentation and easier client integration.

## OpenAPI Documentation & Interactive API Experience
...
1. **Visit the Specification URL:**  
   Open your browser and navigate to [http://localhopst:5001/openapi.yaml](http://localhopst:5001/openapi.yaml) to view the YAML file that outlines your API.
   
2. **Integrate with API Tools:**  
   Import the OpenAPI spec into tools such as Swagger UI, Postman, or Thunder Client to interactively explore and test your endpoints.

3. **Generate Client Code:**  
   Leverage the specification for generating client libraries and SDKs automatically. Many frameworks and tools can import OpenAPI specs to streamline client integration.

4. **Stay Up-to-Date:**  
   The documentation is regenerated every time you run your local development server, ensuring that any new endpoints or changes in parameter validation are immediately reflected.

Using this live documentation makes it easier to understand, test, and integrate with your Consumption APIs throughout your development lifecycle.
