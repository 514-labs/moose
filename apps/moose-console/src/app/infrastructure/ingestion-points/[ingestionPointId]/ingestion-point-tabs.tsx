...
export default function IngestionPointTabs({ingestionPoint, cliData, jsSnippet, pythonSnippet, clickhouseJSSnippet, clickhousePythonSnippet}: IngestionPointTabsProps) {
                        ...
                        <div className="pb-4">
                          ...
                          <SnippetCard title="Ingestion point">
                            <code className="bg-muted">
                              {cliData.project && `http://${cliData.project.local_webserver_config.host}:${cliData.project.local_webserver_config.port}/${ingestionPoint.route_path}`}
                            </code>
                          </SnippetCard>
                        </div>
                        <div className="py-4">
