...
The OlapTable class provides a powerful `insert()` method that allows you to directly insert data into ClickHouse tables with comprehensive validation and error handling.
...
<Callout type="warning" title="Python support coming soon">
Python support for direct insert is not yet available. Stay tuned for updates!
</Callout>

### Validation Methods

The OlapTable provides three validation methods powered by typia for comprehensive type checking:
...
<Callout type="warning" title="Python support coming soon">
Python support for validation methods is not yet available. Stay tuned for updates!
</Callout>
...
<Callout type="warning" title="Python support coming soon">
Python support for error handling strategies is not yet available. Stay tuned for updates!
</Callout>
...
- **Connection management**: Use `closeClient()` when completely done
