...
<CTACards rows={3} columns={1}>
  ...
  />
  <CTACard
    title="Bootstrap with an Area Code Template"
...
<Callout type="info" title="Managed MooseStack in Production" href="https://www.fiveonefour.com/boreal" ctaLabel="Boreal Cloud" compact>
