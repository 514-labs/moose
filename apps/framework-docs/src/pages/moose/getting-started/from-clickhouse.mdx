...
<Callout type="warning" title="Early Access Feature" ctaLabel="Join Slack" href="https://join.slack.com/t/moose-community/shared_invite/zt-32tt66s7r-WS9wn~FAFEe31cFBtJeaFA">
...
<CTACard
  ...
  description="Learn more about Moose APIs and how to use them with your existing ClickHouse."
  ctaLink={PathConfig.consumptionApis.path}
  Icon={PathConfig.consumptionApis.icon}
  orientation="horizontal"
/> 
<CTACard
  title="Learn More About Materialized Views"
  description="Learn how to add Materialized Views to your ClickHouse with Moose"
  ctaLink={PathConfig.materializedViews.path}
  Icon={PathConfig.materializedViews.icon}
  orientation="horizontal"
/> 
</CTACards>
...
<ToggleBlock openText="Show troubleshooting" closeText="Hide troubleshooting">
