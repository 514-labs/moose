...
<Python>
  | Clickhouse | Python | Moose | | :--------- | :------- | :---- | | String |
  str | ✅ | | Boolean | bool | ✅ | | Int64 | int | ✅ | | Int256 | int | ❌ |
  | Float64 | float | ✅ | | Decimal | float | ✅ | | DateTime | datetime | ✅ |
  | Json | dict | ❌ | | Bytes | bytes | ❌ | | Array | list | ✅ | | nullable |
  nullable | ✅ |
</Python>
