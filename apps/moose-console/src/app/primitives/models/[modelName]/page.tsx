                          ...
                          >
                            ...
                            >
                              <div className="flex flex-row grow">
                                <div
                                  key={index}
                                  className="flex grow py-4 space-x-4"
                                >
                                  <div className="grow basis-1">
                                    {table.name}
                                  </div>
                                  <div className="grow basis-1 text-muted-foreground">
                                    {table.name.includes("view")
                                      ? "view"
                                      : "table"}
                                  </div>
                                </div>
                  ...
                  <Card className="rounded-3xl">
                    <CardHeader className="text-xl  text-muted-foreground">
                      ...
                      <CardDescription>
                        ...
                        up infrastructure to ingest data. You can easily push
                        data to this infrastructure in the following ways:
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="pb-4">
                        ...
                        <SnippetCard title="Ingestion point">
                          <code className="bg-muted">
                            {data.project &&
                              `http://${data.project.local_webserver_config.host}:${data.project.local_webserver_config.port}/${infra.ingestionPoints[0].route_path}`}
                          </code>
                        </SnippetCard>
                      </div>
                      <div className="py-4">
                        ...
                        <SnippetCard title="Step 1: Link autogenerated SDKs to make them globally available">
                          <code className="text-nowrap">
                            {`// from the sdk package directory ${
                              data.project && data.project.project_file_location
                            }/.moose/${data.project.name}-sdk`}
                          </code>
