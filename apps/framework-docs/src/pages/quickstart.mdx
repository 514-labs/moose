...
<Callout type="info">
  Windows is not supported at this time, but may work using WSL Windows
  Subsystem for Linux
</Callout>
...
<Callout
  type="warning"
  title="Make sure Docker is running before you start your dev server"
>
  This is required because the local instances of Clickhouse and Redpanda are
